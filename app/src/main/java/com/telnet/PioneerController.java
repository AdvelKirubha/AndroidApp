...
import com.telnet.BaseTools;
import com.telnet.MainActivity;
import com.telnet.ResponseTest;
import com.telnet.TelnetClient;
...
public class PioneerController{
    ...
    public PioneerController(String ip, int port, HomeScreen con) throws IOException, InterruptedException {
